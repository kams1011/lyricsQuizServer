                ...
                .andDo(document(documentPath,
                        ...
                        responseFields(
                                ...
                                .and(
                                    ...
                                    fieldWithPath("data.playTime.startTime").type(JsonFieldType.STRING).description("노래 중 퀴즈 시작 시간"),
                                    fieldWithPath("data.playTime.endTime").type(JsonFieldType.STRING).description("노래 중 퀴즈 끝 시간"),
