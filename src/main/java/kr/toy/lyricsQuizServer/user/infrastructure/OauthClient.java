...
public interface OauthClient {
    ...
    @PostMapping(produces = "application/json")//FIXME 파라미터 받아지는지 확인 필요
    OauthProperties.AccessTokenResponse getAccessToken(URI uri, @RequestBody OauthProperties.AccessTokenRequest request);


    @GetMapping // 확인
    Map<String ,String> getUserInfo(URI uri, @RequestHeader(value = "Authorization", required = true) String accessToken); //FIXME return type 변경
